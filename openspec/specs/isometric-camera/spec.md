...
measurable while its low pitch lets height read â€” POC goal #3 (isometric camera view).

## Requirements

### Requirement: Isometric projection

The camera SHALL use an orthographic projection at a fixed 45Â° yaw and a pitch of ~30â€“35Â° (true
isometric is arctan(1/âˆš2) â‰ˆ 35.26Â°), framing the entire board. A 1-tile gap SHALL measure
...
- **THEN** all 30Ã—20 tiles are on screen and equal-sized gaps appear equal-sized regardless of
  board position
